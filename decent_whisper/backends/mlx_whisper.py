...
def transcribe(
    ...
    from .mlx_whisper.transcribe import transcribe as transcribe_mlx
    from lightning_whisper_mlx import lightning

    hf_repo = lightning.models[model_name]["base"]
...
# this is vendored from lightning_whisper_mlx to allow for streaming transcription
def transcribe_audio(
    ...
    **decode_options,
    ...
    from lighting_whisper_mlx.transcribe import ModelHolder, N_FRAMES, N_SAMPLES, log_mel_spectrogram, pad_or_trim, get_tokenizer, LANGUAGES, FRAMES_PER_SECOND, warnings, sys, DecodingOptions, HOP_LENGTH, SAMPLE_RATE, DecodingResult
    import sys
